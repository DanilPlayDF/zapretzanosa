...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,6695-6710,8443,1024-65535,%GameFilter% --wf-udp=443,19294-19344,50000-50100,1024-65535,%GameFilter% ^
...
--filter-tcp=80 --dpi-desync=fake,multisplit --dpi-desync-fake-tls-mod=rnd,dupsid,sni=yandex.ru --dpi-desync-fooling=badseq --new ^
--filter-tcp=443 --dpi-desync=multisplit --dpi-desync-split-pos=2,sniext+1 --dpi-desync-split-seqovl=681 --dpi-desync-split-seqovl-pattern="%BIN%4pda.bin" --new ^
...
--filter-tcp=6695-6710 --dpi-desync=fake,multisplit --dpi-desync-repeats=8 --dpi-desync-fooling=md5sig --dpi-desync-autottl=2 --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" --new ^
