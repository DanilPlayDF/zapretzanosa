...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,1024-65535 --wf-udp=443,19294-19344,50000-50100,1024-65535 ^
...
--filter-tcp=443 --hostlist-exclude="%LISTS%zapret-hosts-exclude.txt" --hostlist="%LISTS%list-zapret.txt" --hostlist-auto="%LISTS%zapret-hosts-auto.txt" --hostlist="%LISTS%list-general.txt" --dpi-desync=multisplit --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
